...
# repeat whats in the {} as many times as whats in the ()  
...
# fixed portion goes inside the {} brackets
# ?seq_along, generate indices according number of entry in cevtor 
# ?double what is this ?
...
#general structure while(condition{#body of the while loop})
```
<br>
